// app/purchase-invoice/add-raw-material/[type]/page.tsx
"use client";
...
export default function AddRawMaterialPurchasePage({ params }: PageProps) {
    ...
    return <AddRawMaterialPurchaseContent type={resolvedParams.type} />;
}

function AddRawMaterialPurchaseContent({ type }: { type: string }) {
    ...
    const addMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            showToast("✅ Facture matières premières ajoutée avec succès", "success");
    ...
    const getPageTitle = () => {
        return "Ajouter Facture d'Achat - Matières Premières";
    };
