...
type PurchaseInvoice = {
  ...
  date: string;
  type: "PURCHASE_ORDER" | "PURCHASE_INVOICE" | "PURCHASE_REFUND" | "RAW_MATERIAL_PURCHASE";
...
const getTypeLabel = (type: string) => {
  switch (type) {
    ...
    case "RAW_MATERIAL_PURCHASE":
      return "Facture achat matiere premiere";
    default:
      return type;
  }
};
...
export default function ListPurchaseInvoicePage() {
  ...
  const getAddRoute = () => {
    ...
    switch (type) {
      case "RAW_MATERIAL_PURCHASE":
        return "/purchase-invoice/add-raw-material/RAW_MATERIAL_PURCHASE";
      default:
        return "/purchase-invoice/add/" + type;
    }
  };
  ...
  const handleEdit = (invoice: PurchaseInvoice) => {
    ...
    switch (type) {
      case "RAW_MATERIAL_PURCHASE":
        router.push(`/purchase-invoice/edit-raw-material/${invoice.id}`);
        break;
      default:
        router.push(`/purchase-invoice/edit/${invoice.id}`);
        break;
