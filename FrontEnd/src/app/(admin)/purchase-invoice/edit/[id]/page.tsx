// app/purchase-invoice/edit-product/[id]/page.tsx
"use client";
...
export default function EditProductPurchasePage({ params }: PageProps) {
  ...
  return <EditProductPurchaseContent id={resolvedParams.id} />;
}

function EditProductPurchaseContent({ id }: { id: string }) {
  ...
  useEffect(() => {
    if (invoice) {
      ...
      const productItems: InvoiceItem[] = [];
    ...
    const newItems = invoiceItems.map((item, i) => {
      if (i === index) {
        ...
        if (field === "productId") {
          ...
          updatedItem.price = selectedProduct ? roundTo3Decimals(selectedProduct.purchasePrice) : 0;
  ...
  const submitForm = async (event: React.FormEvent) => {
    ...
    // Add products with their IDs for update
    ...
    selectedServices.forEach((service) => {
      items.push({
        ...
        quantity: 1,
        price: roundTo3Decimals(service.price),
      });
    });
  ...
  return (
    <Toast.Provider>
      <div className="p-6">
        <PageBreadcrumb pageTitle="Modifier Facture d'Achat - Produits & Services" />
        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
            <h3 className="text-xl font-semibold text-black dark:text-white">
              Modifier Facture d'Achat - Produits & Services
            </h3>
          </div>
            ...
            <div className="p-6.5">
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value="Facture d'achat - Produits"
                    readOnly
                    disabled
              ...
              <div className="mt-6">
                <div className="flex justify-between items-center mb-4">
                  <h4 className="text-md font-semibold">Produits</h4>
                  <button
                    type="button"
