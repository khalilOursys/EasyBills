...
const updateSaleInvoice = async ({ id, data }: { id: string; data: SaleInvoiceData }) => {
...
function UpdateShippingNoteInvoiceContent({ id }: { id: string }) {
        ...
        const loadInvoice = async () => {
            try {
                ...
                if (data.cities && data.cities.length > 0) {
                    const citiesFromInvoice = data.cities.map((cityRelation: CityRelation) => ({
    ...
    const submitForm = async (event: React.FormEvent) => {
        ...
        const invoiceData: SaleInvoiceData = {
            ...
            cityIds: selectedCities.map((city: SelectOption) => city.value),
        };
                        ...
                        <div className="p-6.5">
                            ...
                            <div className="mt-6 flex gap-4">
                                ...
                                <button
                                    ...
                                    className="rounded-md bg-primary px-6 py-3 font-medium text-white hover:bg-primary-dark transition-colors"
                                >
